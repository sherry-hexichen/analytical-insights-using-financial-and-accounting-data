# -*- coding: utf-8 -*-
"""
Created on Sun Feb 23 19:23:02 2020

@author: Sherry.He
"""

"""Coding Exercise 2. Part 2 - Extension - 2010 to 2018"""
...
raw = conn.raw_sql("""
                     ...
                     exchg in (11,12) and (fyear<2019 and fyear>2008)
                     """)
...
crsp_m = conn.raw_sql("""
                      ...
                      where a.date between '01/01/2010' and '12/31/2019'
